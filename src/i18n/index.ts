...
const translations = {
  en: {
    ...
    'settings.permission.desc': 'Read-only = deny all file changes; workspace write = file tools limited to the vault; full access = terminal-level permissions (use with care).',
  ...
  zh: {
    ...
    'settings.permission.desc': '只读 = 拒绝所有文件修改;工作区写入 = 文件工具限 vault 内;完全访问 = 等同终端权限(谨慎)。',
